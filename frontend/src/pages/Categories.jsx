  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-[#1e293b] border border-gray-700 rounded-2xl overflow-hidden">
        <div className="hidden md:grid grid-cols-12 bg-[#0f172a] text-gray-300 px-6 py-4 font-medium">
        ...
        {categories.map((category, index) => {
          ...
          return (
            <div
              key={category.name}
              className="grid grid-cols-1 md:grid-cols-12 md:items-center gap-4 border-t border-gray-700 px-4 sm:px-6 py-5 hover:bg-[#273449] transition"
            >
              ...
              <span className="hidden md:block md:col-span-3 text-gray-300">
                {category.count} {category.count === 1 ? "entry" : "entries"}
              </span>
              ...
              <span className="md:col-span-2 md:text-right font-semibold">
