...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] text-white relative overflow-hidden">
      <div className="absolute w-[500px] h-[500px] bg-purple-600/30 rounded-full blur-3xl top-[-100px] left-[-100px] pointer-events-none" />
      <div className="absolute w-[400px] h-[400px] bg-indigo-600/30 rounded-full blur-3xl bottom-[-100px] right-[-100px] pointer-events-none" />
      ...
      <div className="relative z-10 bg-[#1e293b]/80 backdrop-blur-xl border border-gray-700 shadow-2xl rounded-3xl p-8 w-full max-w-md">
        <div className="flex items-center gap-2 mb-6 justify-center">
          ...
          <span className="text-2xl font-bold text-purple-400">Arthix</span>
        </div>
